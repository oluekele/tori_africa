    ...
    <div className='mb-10 overflow-hidden'>
      ...
      <div className=' md:h-[450px] md:ml-[60px] pt-10 md:flex ml-[20px] gap-3 overflow-hidden z-10 relative'>
        <div className='md:absolute z-10 '>
          <div className=" relative lg:w-[450px] md:w-[340px] w-[350px] sm:mx-auto h-[500px]  bg-[#fff] flex justify-center" id='bg_1' >
            <Image src={bg1} width={450} height={400} alt='bg-1' className='object-cover relative lg:w-[450px] md:w-[340px] w-[350px] h-[400px] rounded-[16px]'/>
